...
The task description contains the full implementation spec and any relevant context from prior phases (research findings, architecture decisions). If the spec is incomplete or ambiguous, ask one focused clarifying question.
